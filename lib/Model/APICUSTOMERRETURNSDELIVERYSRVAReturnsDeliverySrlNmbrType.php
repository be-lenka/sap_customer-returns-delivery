...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliverySrlNmbrType';
    ...
    protected static $openAPITypes = [
        ...
        'to_maintenance_item_object' => '\BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrTypeToMaintenanceItemObject'
    ];
    ...
    */
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrType., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocumentItem($delivery_document_item)
    {
        ...
        if ((mb_strlen($delivery_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_item when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrType., must be smaller than or equal to 6.');
        }
    ...
    public function setSdDocumentCategory($sd_document_category)
    {
        ...
        if ((mb_strlen($sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_category when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrType., must be smaller than or equal to 4.');
        }
     ...
     *
     * @return \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrTypeToMaintenanceItemObject|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliverySrlNmbrTypeToMaintenanceItemObject|null $to_maintenance_item_object to_maintenance_item_object
     *
     * @return self
     */
