...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryHeaderType-update';
    ...
    */
    ...
    public function setBillOfLading($bill_of_lading)
    {
        ...
        if (!is_null($bill_of_lading) && (mb_strlen($bill_of_lading) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDocumentBySupplier($delivery_document_by_supplier)
    {
        ...
        if (!is_null($delivery_document_by_supplier) && (mb_strlen($delivery_document_by_supplier) > 35)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_by_supplier when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderVolumeUnit($header_volume_unit)
    {
        ...
        if (!is_null($header_volume_unit) && (mb_strlen($header_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_volume_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setHeaderWeightUnit($header_weight_unit)
    {
        ...
        if (!is_null($header_weight_unit) && (mb_strlen($header_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_weight_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 28.');
        }
    ...
    public function setProposedDeliveryRoute($proposed_delivery_route)
    {
        ...
        if (!is_null($proposed_delivery_route) && (mb_strlen($proposed_delivery_route) > 6)) {
            throw new \InvalidArgumentException('invalid length for $proposed_delivery_route when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 6.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 2.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if (!is_null($unloading_point_name) && (mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeUpdate., must be smaller than or equal to 25.');
        }
