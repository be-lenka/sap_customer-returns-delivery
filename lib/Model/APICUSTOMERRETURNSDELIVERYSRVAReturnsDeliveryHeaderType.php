...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryHeaderType';
    ...
    protected static $openAPITypes = [
        ...
        'receiving_location_time_zone' => 'string',
        ...
        'to_delivery_document_item' => '\BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentItem',
        'to_delivery_document_partner' => '\BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentPartner'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'receiving_location_time_zone' => null,
    ...
    protected static array $openAPINullables = [
		...
		'receiving_location_time_zone' => true,
    ...
    protected static $attributeMap = [
        ...
        'receiving_location_time_zone' => 'ReceivingLocationTimeZone',
    ...
    protected static $setters = [
        ...
        'receiving_location_time_zone' => 'setReceivingLocationTimeZone',
    ...
    protected static $getters = [
        ...
        'receiving_location_time_zone' => 'getReceivingLocationTimeZone',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('receiving_location_time_zone', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['receiving_location_time_zone']) && (mb_strlen($this->container['receiving_location_time_zone']) > 6)) {
            $invalidProperties[] = "invalid value for 'receiving_location_time_zone', the character length must be smaller than or equal to 6.";
        }
    ...
    public function setActualDeliveryRoute($actual_delivery_route)
    {
        ...
        if (!is_null($actual_delivery_route) && (mb_strlen($actual_delivery_route) > 6)) {
            throw new \InvalidArgumentException('invalid length for $actual_delivery_route when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 6.');
        }
    ...
    public function setBillOfLading($bill_of_lading)
    {
        ...
        if (!is_null($bill_of_lading) && (mb_strlen($bill_of_lading) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 35.');
        }
    ...
    public function setCreatedByUser($created_by_user)
    {
        ...
        if (!is_null($created_by_user) && (mb_strlen($created_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $created_by_user when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 12.');
        }
    ...
    public function setCustomerGroup($customer_group)
    {
        ...
        if (!is_null($customer_group) && (mb_strlen($customer_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_group when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocumentBySupplier($delivery_document_by_supplier)
    {
        ...
        if (!is_null($delivery_document_by_supplier) && (mb_strlen($delivery_document_by_supplier) > 35)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_by_supplier when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryDocumentType($delivery_document_type)
    {
        ...
        if (!is_null($delivery_document_type) && (mb_strlen($delivery_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryVersion($delivery_version)
    {
        ...
        if (!is_null($delivery_version) && (mb_strlen($delivery_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $delivery_version when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setDistrStatusByDecentralizedWrhs($distr_status_by_decentralized_wrhs)
    {
        ...
        if (!is_null($distr_status_by_decentralized_wrhs) && (mb_strlen($distr_status_by_decentralized_wrhs) > 1)) {
            throw new \InvalidArgumentException('invalid length for $distr_status_by_decentralized_wrhs when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setExternalIdentificationType($external_identification_type)
    {
        ...
        if (!is_null($external_identification_type) && (mb_strlen($external_identification_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $external_identification_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setExternalTransportSystem($external_transport_system)
    {
        ...
        if (!is_null($external_transport_system) && (mb_strlen($external_transport_system) > 5)) {
            throw new \InvalidArgumentException('invalid length for $external_transport_system when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 5.');
        }
    ...
    public function setFactoryCalendarByCustomer($factory_calendar_by_customer)
    {
        ...
        if (!is_null($factory_calendar_by_customer) && (mb_strlen($factory_calendar_by_customer) > 2)) {
            throw new \InvalidArgumentException('invalid length for $factory_calendar_by_customer when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setGoodsIssueOrReceiptSlipNumber($goods_issue_or_receipt_slip_number)
    {
        ...
        if (!is_null($goods_issue_or_receipt_slip_number) && (mb_strlen($goods_issue_or_receipt_slip_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $goods_issue_or_receipt_slip_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setHandlingUnitInStock($handling_unit_in_stock)
    {
        ...
        if (!is_null($handling_unit_in_stock) && (mb_strlen($handling_unit_in_stock) > 1)) {
            throw new \InvalidArgumentException('invalid length for $handling_unit_in_stock when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHdrGeneralIncompletionStatus($hdr_general_incompletion_status)
    {
        ...
        if (!is_null($hdr_general_incompletion_status) && (mb_strlen($hdr_general_incompletion_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $hdr_general_incompletion_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHdrGoodsMvtIncompletionStatus($hdr_goods_mvt_incompletion_status)
    {
        ...
        if (!is_null($hdr_goods_mvt_incompletion_status) && (mb_strlen($hdr_goods_mvt_incompletion_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $hdr_goods_mvt_incompletion_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHeaderBillgIncompletionStatus($header_billg_incompletion_status)
    {
        ...
        if (!is_null($header_billg_incompletion_status) && (mb_strlen($header_billg_incompletion_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $header_billg_incompletion_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHeaderBillingBlockReason($header_billing_block_reason)
    {
        ...
        if (!is_null($header_billing_block_reason) && (mb_strlen($header_billing_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $header_billing_block_reason when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderDelivIncompletionStatus($header_deliv_incompletion_status)
    {
        ...
        if (!is_null($header_deliv_incompletion_status) && (mb_strlen($header_deliv_incompletion_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $header_deliv_incompletion_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHeaderPackingIncompletionSts($header_packing_incompletion_sts)
    {
        ...
        if (!is_null($header_packing_incompletion_sts) && (mb_strlen($header_packing_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $header_packing_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHeaderPickgIncompletionStatus($header_pickg_incompletion_status)
    {
        ...
        if (!is_null($header_pickg_incompletion_status) && (mb_strlen($header_pickg_incompletion_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $header_pickg_incompletion_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setHeaderVolumeUnit($header_volume_unit)
    {
        ...
        if (!is_null($header_volume_unit) && (mb_strlen($header_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_volume_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 3.');
        }
    ...
    public function setHeaderWeightUnit($header_weight_unit)
    {
        ...
        if (!is_null($header_weight_unit) && (mb_strlen($header_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_weight_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 28.');
        }
    ...
    public function setInternalFinancialDocument($internal_financial_document)
    {
        ...
        if (!is_null($internal_financial_document) && (mb_strlen($internal_financial_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $internal_financial_document when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setIsDeliveryForSingleWarehouse($is_delivery_for_single_warehouse)
    {
        ...
        if (!is_null($is_delivery_for_single_warehouse) && (mb_strlen($is_delivery_for_single_warehouse) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_delivery_for_single_warehouse when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setIsExportDelivery($is_export_delivery)
    {
        ...
        if (!is_null($is_export_delivery) && (mb_strlen($is_export_delivery) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_export_delivery when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setLastChangedByUser($last_changed_by_user)
    {
        ...
        if (!is_null($last_changed_by_user) && (mb_strlen($last_changed_by_user) > 12)) {
            throw new \InvalidArgumentException('invalid length for $last_changed_by_user when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 12.');
        }
    ...
    public function setLoadingPoint($loading_point)
    {
        ...
        if (!is_null($loading_point) && (mb_strlen($loading_point) > 2)) {
            throw new \InvalidArgumentException('invalid length for $loading_point when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setMeansOfTransport($means_of_transport)
    {
        ...
        if (!is_null($means_of_transport) && (mb_strlen($means_of_transport) > 20)) {
            throw new \InvalidArgumentException('invalid length for $means_of_transport when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 20.');
        }
    ...
    public function setMeansOfTransportRefMaterial($means_of_transport_ref_material)
    {
        ...
        if (!is_null($means_of_transport_ref_material) && (mb_strlen($means_of_transport_ref_material) > 40)) {
            throw new \InvalidArgumentException('invalid length for $means_of_transport_ref_material when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 40.');
        }
    ...
    public function setMeansOfTransportType($means_of_transport_type)
    {
        ...
        if (!is_null($means_of_transport_type) && (mb_strlen($means_of_transport_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $means_of_transport_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setOrderId($order_id)
    {
        ...
        if (!is_null($order_id) && (mb_strlen($order_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $order_id when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 12.');
        }
    ...
    public function setOverallDelivConfStatus($overall_deliv_conf_status)
    {
        ...
        if (!is_null($overall_deliv_conf_status) && (mb_strlen($overall_deliv_conf_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_deliv_conf_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallDelivReltdBillgStatus($overall_deliv_reltd_billg_status)
    {
        ...
        if (!is_null($overall_deliv_reltd_billg_status) && (mb_strlen($overall_deliv_reltd_billg_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_deliv_reltd_billg_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallGoodsMovementStatus($overall_goods_movement_status)
    {
        ...
        if (!is_null($overall_goods_movement_status) && (mb_strlen($overall_goods_movement_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_goods_movement_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallIntcoBillingStatus($overall_intco_billing_status)
    {
        ...
        if (!is_null($overall_intco_billing_status) && (mb_strlen($overall_intco_billing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_intco_billing_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallPackingStatus($overall_packing_status)
    {
        ...
        if (!is_null($overall_packing_status) && (mb_strlen($overall_packing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_packing_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallPickingConfStatus($overall_picking_conf_status)
    {
        ...
        if (!is_null($overall_picking_conf_status) && (mb_strlen($overall_picking_conf_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_picking_conf_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallPickingStatus($overall_picking_status)
    {
        ...
        if (!is_null($overall_picking_status) && (mb_strlen($overall_picking_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_picking_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallProofOfDeliveryStatus($overall_proof_of_delivery_status)
    {
        ...
        if (!is_null($overall_proof_of_delivery_status) && (mb_strlen($overall_proof_of_delivery_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_proof_of_delivery_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallSdProcessStatus($overall_sd_process_status)
    {
        ...
        if (!is_null($overall_sd_process_status) && (mb_strlen($overall_sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_process_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallWarehouseActivityStatus($overall_warehouse_activity_status)
    {
        ...
        if (!is_null($overall_warehouse_activity_status) && (mb_strlen($overall_warehouse_activity_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_warehouse_activity_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmDelivIncompletionSts($ovrl_itm_deliv_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_deliv_incompletion_sts) && (mb_strlen($ovrl_itm_deliv_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_deliv_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmGdsMvtIncompletionSts($ovrl_itm_gds_mvt_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_gds_mvt_incompletion_sts) && (mb_strlen($ovrl_itm_gds_mvt_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_gds_mvt_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmGeneralIncompletionSts($ovrl_itm_general_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_general_incompletion_sts) && (mb_strlen($ovrl_itm_general_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_general_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmPackingIncompletionSts($ovrl_itm_packing_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_packing_incompletion_sts) && (mb_strlen($ovrl_itm_packing_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_packing_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmPickingIncompletionSts($ovrl_itm_picking_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_picking_incompletion_sts) && (mb_strlen($ovrl_itm_picking_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_picking_incompletion_sts when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setPaymentGuaranteeProcedure($payment_guarantee_procedure)
    {
        ...
        if (!is_null($payment_guarantee_procedure) && (mb_strlen($payment_guarantee_procedure) > 6)) {
            throw new \InvalidArgumentException('invalid length for $payment_guarantee_procedure when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 6.');
        }
    ...
    public function setPickedItemsLocation($picked_items_location)
    {
        ...
        if (!is_null($picked_items_location) && (mb_strlen($picked_items_location) > 20)) {
            throw new \InvalidArgumentException('invalid length for $picked_items_location when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 20.');
        }
    ...
    public function setProposedDeliveryRoute($proposed_delivery_route)
    {
        ...
        if (!is_null($proposed_delivery_route) && (mb_strlen($proposed_delivery_route) > 6)) {
            throw new \InvalidArgumentException('invalid length for $proposed_delivery_route when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 6.');
        }
    ...
    /**
     * Gets receiving_location_time_zone
     *
     * @return string|null
     */
    public function getReceivingLocationTimeZone()
    {
        return $this->container['receiving_location_time_zone'];
    }

    /**
     * Sets receiving_location_time_zone
     *
     * @param string|null $receiving_location_time_zone receiving_location_time_zone
     *
     * @return self
     */
    public function setReceivingLocationTimeZone($receiving_location_time_zone)
    {
        if (is_null($receiving_location_time_zone)) {
            array_push($this->openAPINullablesSetToNull, 'receiving_location_time_zone');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('receiving_location_time_zone', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($receiving_location_time_zone) && (mb_strlen($receiving_location_time_zone) > 6)) {
            throw new \InvalidArgumentException('invalid length for $receiving_location_time_zone when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 6.');
        }

        $this->container['receiving_location_time_zone'] = $receiving_location_time_zone;
    ...
    public function setReceivingPlant($receiving_plant)
    {
        ...
        if (!is_null($receiving_plant) && (mb_strlen($receiving_plant) > 4)) {
            throw new \InvalidArgumentException('invalid length for $receiving_plant when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setRouteSchedule($route_schedule)
    {
        ...
        if (!is_null($route_schedule) && (mb_strlen($route_schedule) > 10)) {
            throw new \InvalidArgumentException('invalid length for $route_schedule when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 6.');
        }
    ...
    public function setSalesOffice($sales_office)
    {
        ...
        if (!is_null($sales_office) && (mb_strlen($sales_office) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_office when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setSdDocumentCategory($sd_document_category)
    {
        ...
        if (!is_null($sd_document_category) && (mb_strlen($sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_category when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setShipmentBlockReason($shipment_block_reason)
    {
        ...
        if (!is_null($shipment_block_reason) && (mb_strlen($shipment_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipment_block_reason when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 2.');
        }
    ...
    public function setShipToParty($ship_to_party)
    {
        ...
        if (!is_null($ship_to_party) && (mb_strlen($ship_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $ship_to_party when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setSpecialProcessingCode($special_processing_code)
    {
        ...
        if (!is_null($special_processing_code) && (mb_strlen($special_processing_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $special_processing_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setStatisticsCurrency($statistics_currency)
    {
        ...
        if (!is_null($statistics_currency) && (mb_strlen($statistics_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $statistics_currency when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 5.');
        }
    ...
    public function setSupplier($supplier)
    {
        ...
        if (!is_null($supplier) && (mb_strlen($supplier) > 10)) {
            throw new \InvalidArgumentException('invalid length for $supplier when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
    ...
    public function setTotalBlockStatus($total_block_status)
    {
        ...
        if (!is_null($total_block_status) && (mb_strlen($total_block_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $total_block_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setTotalCreditCheckStatus($total_credit_check_status)
    {
        ...
        if (!is_null($total_credit_check_status) && (mb_strlen($total_credit_check_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $total_credit_check_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setTotalNumberOfPackage($total_number_of_package)
    {
        ...
        if (!is_null($total_number_of_package) && (mb_strlen($total_number_of_package) > 5)) {
            throw new \InvalidArgumentException('invalid length for $total_number_of_package when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 5.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 5.');
        }
    ...
    public function setTransportationGroup($transportation_group)
    {
        ...
        if (!is_null($transportation_group) && (mb_strlen($transportation_group) > 4)) {
            throw new \InvalidArgumentException('invalid length for $transportation_group when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 4.');
        }
    ...
    public function setTransportationPlanningStatus($transportation_planning_status)
    {
        ...
        if (!is_null($transportation_planning_status) && (mb_strlen($transportation_planning_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $transportation_planning_status when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 1.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if (!is_null($unloading_point_name) && (mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 25.');
        }
    ...
    public function setWarehouse($warehouse)
    {
        ...
        if (!is_null($warehouse) && (mb_strlen($warehouse) > 3)) {
            throw new \InvalidArgumentException('invalid length for $warehouse when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 3.');
        }
    ...
    public function setWarehouseGate($warehouse_gate)
    {
        ...
        if (!is_null($warehouse_gate) && (mb_strlen($warehouse_gate) > 3)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_gate when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 3.');
        }
    ...
    public function setWarehouseStagingArea($warehouse_staging_area)
    {
        ...
        if (!is_null($warehouse_staging_area) && (mb_strlen($warehouse_staging_area) > 10)) {
            throw new \InvalidArgumentException('invalid length for $warehouse_staging_area when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderType., must be smaller than or equal to 10.');
        }
     ...
     *
     * @return \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentItem|null $to_delivery_document_item to_delivery_document_item
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentPartner|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeToDeliveryDocumentPartner|null $to_delivery_document_partner to_delivery_document_partner
     *
     * @return self
     */
