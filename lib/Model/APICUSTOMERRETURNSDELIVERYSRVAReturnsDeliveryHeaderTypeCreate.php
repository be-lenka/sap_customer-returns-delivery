...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryHeaderType-create';
    ...
    protected static $openAPITypes = [
        ...
        'to_delivery_document_item' => '\BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentItem',
        'to_delivery_document_partner' => '\BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentPartner'
    ];
    ...
    */
    ...
    public function setBillOfLading($bill_of_lading)
    {
        ...
        if (!is_null($bill_of_lading) && (mb_strlen($bill_of_lading) > 35)) {
            throw new \InvalidArgumentException('invalid length for $bill_of_lading when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryBlockReason($delivery_block_reason)
    {
        ...
        if (!is_null($delivery_block_reason) && (mb_strlen($delivery_block_reason) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_block_reason when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setDeliveryDocumentBySupplier($delivery_document_by_supplier)
    {
        ...
        if (!is_null($delivery_document_by_supplier) && (mb_strlen($delivery_document_by_supplier) > 35)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_by_supplier when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 35.');
        }
    ...
    public function setDeliveryPriority($delivery_priority)
    {
        ...
        if (!is_null($delivery_priority) && (mb_strlen($delivery_priority) > 2)) {
            throw new \InvalidArgumentException('invalid length for $delivery_priority when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setHeaderVolumeUnit($header_volume_unit)
    {
        ...
        if (!is_null($header_volume_unit) && (mb_strlen($header_volume_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_volume_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setHeaderWeightUnit($header_weight_unit)
    {
        ...
        if (!is_null($header_weight_unit) && (mb_strlen($header_weight_unit) > 3)) {
            throw new \InvalidArgumentException('invalid length for $header_weight_unit when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 28.');
        }
    ...
    public function setProposedDeliveryRoute($proposed_delivery_route)
    {
        ...
        if (!is_null($proposed_delivery_route) && (mb_strlen($proposed_delivery_route) > 6)) {
            throw new \InvalidArgumentException('invalid length for $proposed_delivery_route when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 6.');
        }
    ...
    public function setShippingPoint($shipping_point)
    {
        ...
        if (!is_null($shipping_point) && (mb_strlen($shipping_point) > 4)) {
            throw new \InvalidArgumentException('invalid length for $shipping_point when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 4.');
        }
    ...
    public function setShippingType($shipping_type)
    {
        ...
        if (!is_null($shipping_type) && (mb_strlen($shipping_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 2.');
        }
    ...
    public function setUnloadingPointName($unloading_point_name)
    {
        ...
        if (!is_null($unloading_point_name) && (mb_strlen($unloading_point_name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $unloading_point_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreate., must be smaller than or equal to 25.');
        }
     ...
     *
     * @return \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentItem|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentItem|null $to_delivery_document_item to_delivery_document_item
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentPartner|null
     */
     ...
     *
     * @param \BeLenka\SAP\CustomerReturnsDelivery\Model\APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryHeaderTypeCreateToDeliveryDocumentPartner|null $to_delivery_document_partner to_delivery_document_partner
     *
     * @return self
     */
