...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryAddressType';
    ...
    */
    ...
    public function setTransportZone($transport_zone)
    {
        ...
        if ((mb_strlen($transport_zone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $transport_zone when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setTaxJurisdiction($tax_jurisdiction)
    {
        ...
        if ((mb_strlen($tax_jurisdiction) > 15)) {
            throw new \InvalidArgumentException('invalid length for $tax_jurisdiction when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 15.');
        }
    ...
    public function setStreetSuffixName($street_suffix_name)
    {
        ...
        if ((mb_strlen($street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_suffix_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetSearch($street_search)
    {
        ...
        if ((mb_strlen($street_search) > 25)) {
            throw new \InvalidArgumentException('invalid length for $street_search when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 25.');
        }
    ...
    public function setStreetPrefixName($street_prefix_name)
    {
        ...
        if ((mb_strlen($street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street_prefix_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setStreetName($street_name)
    {
        ...
        if ((mb_strlen($street_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 60.');
        }
    ...
    public function setSearchTerm1($search_term1)
    {
        ...
        if ((mb_strlen($search_term1) > 20)) {
            throw new \InvalidArgumentException('invalid length for $search_term1 when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 20.');
        }
    ...
    public function setRoomNumber($room_number)
    {
        ...
        if ((mb_strlen($room_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $room_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if ((mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setPrfrdCommMediumType($prfrd_comm_medium_type)
    {
        ...
        if ((mb_strlen($prfrd_comm_medium_type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $prfrd_comm_medium_type when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setPostalCode($postal_code)
    {
        ...
        if ((mb_strlen($postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postal_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBoxPostalCode($po_box_postal_code)
    {
        ...
        if ((mb_strlen($po_box_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box_postal_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPoBoxLobbyName($po_box_lobby_name)
    {
        ...
        if ((mb_strlen($po_box_lobby_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_lobby_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBoxDeviatingRegion($po_box_deviating_region)
    {
        ...
        if ((mb_strlen($po_box_deviating_region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_region when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setPoBoxDeviatingCountry($po_box_deviating_country)
    {
        ...
        if ((mb_strlen($po_box_deviating_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_country when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setPoBoxDeviatingCityName($po_box_deviating_city_name)
    {
        ...
        if ((mb_strlen($po_box_deviating_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $po_box_deviating_city_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setPoBox($po_box)
    {
        ...
        if ((mb_strlen($po_box) > 10)) {
            throw new \InvalidArgumentException('invalid length for $po_box when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if ((mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 30.');
        }
    ...
    public function setPerson($person)
    {
        ...
        if ((mb_strlen($person) > 10)) {
            throw new \InvalidArgumentException('invalid length for $person when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setNation($nation)
    {
        ...
        if ((mb_strlen($nation) > 1)) {
            throw new \InvalidArgumentException('invalid length for $nation when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 1.');
        }
    ...
    public function setHouseNumberSupplementText($house_number_supplement_text)
    {
        ...
        if ((mb_strlen($house_number_supplement_text) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number_supplement_text when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setHouseNumber($house_number)
    {
        ...
        if ((mb_strlen($house_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $house_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setHomeCityName($home_city_name)
    {
        ...
        if ((mb_strlen($home_city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $home_city_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setFullName($full_name)
    {
        ...
        if ((mb_strlen($full_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $full_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 80.');
        }
    ...
    public function setFormOfAddress($form_of_address)
    {
        ...
        if ((mb_strlen($form_of_address) > 4)) {
            throw new \InvalidArgumentException('invalid length for $form_of_address when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 4.');
        }
    ...
    public function setFloor($floor)
    {
        ...
        if ((mb_strlen($floor) > 10)) {
            throw new \InvalidArgumentException('invalid length for $floor when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setFaxNumber($fax_number)
    {
        ...
        if ((mb_strlen($fax_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $fax_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 30.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if ((mb_strlen($district) > 40)) {
            throw new \InvalidArgumentException('invalid length for $district when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setDeliveryServiceTypeCode($delivery_service_type_code)
    {
        ...
        if ((mb_strlen($delivery_service_type_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $delivery_service_type_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 4.');
        }
    ...
    public function setDeliveryServiceNumber($delivery_service_number)
    {
        ...
        if ((mb_strlen($delivery_service_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_service_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if ((mb_strlen($county) > 40)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if ((mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 3.');
        }
    ...
    public function setCorrespondenceLanguage($correspondence_language)
    {
        ...
        if ((mb_strlen($correspondence_language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $correspondence_language when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 2.');
        }
    ...
    public function setCompanyPostalCode($company_postal_code)
    {
        ...
        if ((mb_strlen($company_postal_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $company_postal_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setCitySearch($city_search)
    {
        ...
        if ((mb_strlen($city_search) > 25)) {
            throw new \InvalidArgumentException('invalid length for $city_search when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 25.');
        }
    ...
    public function setCityName($city_name)
    {
        ...
        if ((mb_strlen($city_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if ((mb_strlen($city_code) > 12)) {
            throw new \InvalidArgumentException('invalid length for $city_code when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 12.');
        }
    ...
    public function setCareOfName($care_of_name)
    {
        ...
        if ((mb_strlen($care_of_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $care_of_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName4($business_partner_name4)
    {
        ...
        if ((mb_strlen($business_partner_name4) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name4 when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName3($business_partner_name3)
    {
        ...
        if ((mb_strlen($business_partner_name3) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name3 when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName2($business_partner_name2)
    {
        ...
        if ((mb_strlen($business_partner_name2) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name2 when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setBusinessPartnerName1($business_partner_name1)
    {
        ...
        if ((mb_strlen($business_partner_name1) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_partner_name1 when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setBuilding($building)
    {
        ...
        if ((mb_strlen($building) > 20)) {
            throw new \InvalidArgumentException('invalid length for $building when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 20.');
        }
    ...
    public function setAddressTimeZone($address_time_zone)
    {
        ...
        if ((mb_strlen($address_time_zone) > 6)) {
            throw new \InvalidArgumentException('invalid length for $address_time_zone when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 6.');
        }
    ...
    public function setAddressId($address_id)
    {
        ...
        if ((mb_strlen($address_id) > 10)) {
            throw new \InvalidArgumentException('invalid length for $address_id when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 10.');
        }
    ...
    public function setAdditionalStreetSuffixName($additional_street_suffix_name)
    {
        ...
        if ((mb_strlen($additional_street_suffix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_suffix_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
    ...
    public function setAdditionalStreetPrefixName($additional_street_prefix_name)
    {
        ...
        if ((mb_strlen($additional_street_prefix_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $additional_street_prefix_name when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryAddressType., must be smaller than or equal to 40.');
        }
