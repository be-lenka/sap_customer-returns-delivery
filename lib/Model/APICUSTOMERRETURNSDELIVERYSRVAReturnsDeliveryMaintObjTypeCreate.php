...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryMaintObjTypeCreate Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryMaintObjTypeCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryMaintObjType-create';
    ...
    */
    ...
    public function setSerialNumber($serial_number)
    {
        ...
        if ((mb_strlen($serial_number) > 18)) {
            throw new \InvalidArgumentException('invalid length for $serial_number when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryMaintObjTypeCreate., must be smaller than or equal to 18.');
        }
