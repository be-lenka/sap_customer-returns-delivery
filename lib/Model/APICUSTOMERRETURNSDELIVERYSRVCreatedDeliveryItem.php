...
/**
 * APICUSTOMERRETURNSDELIVERYSRVCreatedDeliveryItem Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVCreatedDeliveryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.CreatedDeliveryItem';
    ...
    */
    ...
    public function setDeliveryDocument($delivery_document)
    {
        ...
        if ((mb_strlen($delivery_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document when calling APICUSTOMERRETURNSDELIVERYSRVCreatedDeliveryItem., must be smaller than or equal to 10.');
        }
    ...
    public function setDeliveryDocumentItem($delivery_document_item)
    {
        ...
        if ((mb_strlen($delivery_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $delivery_document_item when calling APICUSTOMERRETURNSDELIVERYSRVCreatedDeliveryItem., must be smaller than or equal to 6.');
        }
