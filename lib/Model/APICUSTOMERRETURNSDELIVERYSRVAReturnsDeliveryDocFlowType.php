...
/**
 * APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\CustomerReturnsDelivery
 * @author   OpenAPI Generator team
 ...
 */
class APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_CUSTOMER_RETURNS_DELIVERY_SRV.A_ReturnsDeliveryDocFlowType';
    ...
    */
    ...
    public function setDeliveryVersion($delivery_version)
    {
        ...
        if (!is_null($delivery_version) && (mb_strlen($delivery_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $delivery_version when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 4.');
        }
    ...
    public function setPrecedingDocument($preceding_document)
    {
        ...
        if ((mb_strlen($preceding_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 10.');
        }
    ...
    public function setPrecedingDocumentCategory($preceding_document_category)
    {
        ...
        if (!is_null($preceding_document_category) && (mb_strlen($preceding_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document_category when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 4.');
        }
    ...
    public function setPrecedingDocumentItem($preceding_document_item)
    {
        ...
        if ((mb_strlen($preceding_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $preceding_document_item when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 6.');
        }
    ...
    public function setSubsequentdocument($subsequentdocument)
    {
        ...
        if (!is_null($subsequentdocument) && (mb_strlen($subsequentdocument) > 10)) {
            throw new \InvalidArgumentException('invalid length for $subsequentdocument when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 10.');
        }
    ...
    public function setSubsequentDocumentItem($subsequent_document_item)
    {
        ...
        if (!is_null($subsequent_document_item) && (mb_strlen($subsequent_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $subsequent_document_item when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 6.');
        }
    ...
    public function setSdFulfillmentCalculationRule($sd_fulfillment_calculation_rule)
    {
        ...
        if (!is_null($sd_fulfillment_calculation_rule) && (mb_strlen($sd_fulfillment_calculation_rule) > 1)) {
            throw new \InvalidArgumentException('invalid length for $sd_fulfillment_calculation_rule when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 1.');
        }
    ...
    public function setSubsequentDocumentCategory($subsequent_document_category)
    {
        ...
        if ((mb_strlen($subsequent_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $subsequent_document_category when calling APICUSTOMERRETURNSDELIVERYSRVAReturnsDeliveryDocFlowType., must be smaller than or equal to 4.');
        }
